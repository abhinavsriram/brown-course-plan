...
class MyProfileScreenDrawer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      email: "",
  ...
  writeToDatabase = () => {
    console.log(this.state.recommendedClassesFall);
    console.log(this.state.recommendedClassesSpring);
...
export default MyProfileScreenDrawer;
