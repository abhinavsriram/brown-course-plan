...
import CoursePiece from "./../components/CoursePieceDashboard";
...
class SemesterCard extends Component {
  ...
  toggleOnPress = () => {
    this.state.fullyVisible
      ? this.setState({ fullyVisible: false })
      : this.setState({ fullyVisible: true });
  };

  renderCoursePiecesRow1 = () => {
    var results = [];
    var courseObjects = [];
    var courseNames = [];
    var sortedCourseObjects = [];
    ...
    return (
      <React.Fragment>
        {this.state.fullyVisible ? (
            ...
            >
              <View style={{ flexDirection: "row" }}>
                ...
                <TouchableOpacity
                  ...
                  style={truncatedStyles.dropUpContainer}
                >
                  <Icon name="ios-arrow-dropup" color="dimgrey" size={25} />
                </TouchableOpacity>
              </View>
              <View style={{ flexDirection: "row" }}>
                <Text style={[styles.credits, { marginTop: 3 }]}>
          ...
          <TouchableOpacity
            style={truncatedStyles.mainContainer}
            onLongPress={() => {
              this.deleteSemesterAlert();
            }}
            delayLongPress={1000}
          ...
          >
            <Text style={styles.title}>{this.state.title}</Text>
            <View style={{ flexDirection: "row" }}>
              {this.renderCoursePiecesRow1()}
            </View>
            <View style={{ flexDirection: "row" }}>
              {this.renderCoursePiecesRow2()}
            </View>
            <TouchableOpacity
              onPress={() => {
                this.toggleOnPress();
              }}
              style={truncatedStyles.dropdownContainer}
            >
              <Icon name="ios-arrow-dropdown" color="dimgrey" size={25} />
            </TouchableOpacity>
          </TouchableOpacity>
        )}
      </React.Fragment>
...
const truncatedStyles = StyleSheet.create({
  mainContainer: {
    borderColor: "#E3E3E3",
    borderWidth: 3,
    borderRadius: 15,
